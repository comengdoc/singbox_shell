...
目前支持系统为deiban/ubuntu/armbian

## 一键脚本：(请自行安装curl和bash，如果缺少的话)
```
bash <(curl -sL https://ghfast.top/https://raw.githubusercontent.com/comengdoc/singbox_shell/refs/heads/main/sbshell.sh)
```
- 初始化运行结束，输入“**sb**”进入菜单
- 目前支持系统为deiban/ubuntu/armbian。  
...
### 发行版1.12:
fakeiptrpoxy:
https://raw.githubusercontent.com/comengdoc/singbox_shell/refs/heads/main/config/config_fakeiptrpoxy12.json

fakeiptun:
https://raw.githubusercontent.com/comengdoc/singbox_shell/refs/heads/main/config/config_fakeiptun12.json

tproxy:
https://raw.githubusercontent.com/comengdoc/singbox_shell/refs/heads/main/config/config_trpoxy12.json
